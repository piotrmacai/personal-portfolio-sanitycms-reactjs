    ...
    return (
        <section id="cta" className="ctaContainer">
            ...
            <div className="cta_section2">
                ...
                <div className="cta_section_info">
                    <p className="cta_section_info_p">{t('designcta_subtitle2')} </p>
                    <h2 data-aos="zoom-in" className="cta_section_info_h2">
                    {t('designcta_title2')}
                    </h2>
                    <p className="cta_section_info_basicp">{t('designcta_desc2')}</p>
                    <a href="/contact">
...
export default AppWrap(MotionWrap(DesignCta, 'app__aicta'), 'aicta', 'app__whitebg');